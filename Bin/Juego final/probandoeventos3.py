...
def main():
        ...
        while not gameOver:
                ...
                if (nivel==1):
                        ...
                        DDA(490, 700, 490+30*10, 700, 255/255, 0/255,0/255, 10)
                        DDA(490, 700, 490+VidaMonster*10, 700, 0/255, 0/255,250/255, 10)
                        
                        #Mostramos la vida del monster
                        #set_pixel( 500, 700, 0/255, 0/255,250/255, 100)
                        DDA(100, 700, 100+15*10, 700, 255/255, 0/255,0/255, 10)
                        DDA(100, 700, 100+VidaHumano*10, 700, 0/255, 250/255,0/255, 10)
                        if (VidaHumano==0):
                ...
                if nivel==2:
                        ...
                        if (VidaMonster<15):
                                ...
                                if posxcriatura<0:
                                        ...
                                        posxcriatura=posxcriatura-10
                        #verificar daño al soldaditoo :v
                        if abs(xjugador -posxcriatura)<10 and 0<posycriatura-yjugador <80:
                                VidaHumano=VidaHumano-1
                                print("Vida humano",VidaHumano)
                        #Mostramos la vida del monster
                        #set_pixel( 500, 700, 0/255, 0/255,250/255, 100)
                ...
                if nivel==3:
                        ...
                        if isShot:
                                ...
                                origenbalay=yjugador
                        #Verificar daño hacia el mountruo
                        if abs(origenbalax -posxmonster)<10:
                                VidaMonster=VidaMonster-1
                                print("Vida Monster",VidaMonster)
                                isShot=False
                        #Agonia del mountruo
                        if VidaMonster%2==0:
                                Dragon(posxmonster,posymonster,10)
                        else:
                                Dragon(posxmonster,posymonster,10)
