...
- Posteriormente se hace uso de la libreria (Pygame 1.9.3,PyOPENGL 3.1.5) - _PyOpenGL-accelerate_ - [Instalar PyOpenGL-accelerate](https://pypi.org/project/PyOpenGL-accelerate/).
